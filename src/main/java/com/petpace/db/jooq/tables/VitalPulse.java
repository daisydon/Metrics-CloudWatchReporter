...
public class VitalPulse extends org.jooq.impl.TableImpl<com.petpace.db.jooq.tables.records.VitalPulseRecord> {
	...
	private static final long serialVersionUID = -1699605165;

	/**
	 * The singleton instance of <code>sirius.vital_pulse</code>
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.id</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.collar_id</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.pet_id</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.name</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.quality</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.deviation</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.duration</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.value</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.smv10</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.smv30</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.debug</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.exhale</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.exhale_std</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.inhale</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.inhale_std</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.nn</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.nn_std</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.ipr</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.ipr_std</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.time</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.created</code>. 
	 */
	...
	/**
	 * The column <code>sirius.vital_pulse.notes</code>. 
	 */
	...
	/**
	 * Create a <code>sirius.vital_pulse</code> table reference
	 */
	public VitalPulse() {
		super("vital_pulse", com.petpace.db.jooq.Sirius.SIRIUS);
	}

	/**
	 * Create an aliased <code>sirius.vital_pulse</code> table reference
	 */
	public VitalPulse(java.lang.String alias) {
		super(alias, com.petpace.db.jooq.Sirius.SIRIUS, com.petpace.db.jooq.tables.VitalPulse.VITAL_PULSE);
	}
